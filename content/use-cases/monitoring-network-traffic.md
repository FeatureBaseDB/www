...
|---------------------------------------------|---------|---------|-----|--------------------------------|
| 10.3.2.1<br>8.8.8.8<br>...                  |         |         |     | Source IP Address              |
| 5.4.3.2<br>192.168.1.3<br>...               |         |         |     | Destination IP Address         |
| 34567<br>45388<br>...                       |         |         |     | Source Port                    |
| 80<br>443<br>...                            |         |         |     | Destination Port               |
| IPv4<br>IPv6<br>ICMP<br>...                 |         |         |     | Network Layer Protocol         |
| TCP<br>UDP<br>SCTP                          |         |         |     | Transport Layer Protocol       |
| HTTP<br>DHCP<br>DNS<br>...                  |         |         |     | App Layer Protocol             |
| google.com<br>espn.com<br>...               |         |         |     | Hostname                       |
| POST<br>PUT<br>...                          |         |         |     | HTTP method                    |
| application/html<br>application/json<br>... |         |         |     | Content-Type                   |
| Firefox/Windows<br>Chrome/Linux<br>...      |         |         |     | User Agent                     |
| 1500<br>64<br>...                           |         |         |     | Packet Size (bytes)            |
| ACK<br>SYN<br>...                           |         |         |     | TCP Flags                      |
