...
5. Copy `target/sample-ogg-handler-0.1.0-all.jar` to the `v_dirprm/handler` directory in `sample-ogg-handler`. We  will need to do that any time we modify the handler.
